...
export default function VerifyRequest() {
  return (
    <>
      <Head>
        <title>
          Sols estate: search and share estates requests - verify request
        </title>
        <meta
          name="description"
          content="Verify your email address on Sols Estate. Check your inbox for the email we've sent to the address provided during login/signup. Opening and verifying this email will grant you access to your account, allowing you to fully engage with our platform for real estate requests and personalized experiences."
        />
        <meta
          name="keywords"
          content="Email verification, account activation, confirm email, email confirmation, email verification process, Sols Estate, real estate requests, personalized experience, agent collaboration, property matchmaking, real estate platform"
        />
      </Head>
